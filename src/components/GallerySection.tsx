...
type Category = "all" | "ceremonie" | "coiffure" | "maquillage" | "centre";
...
const photos: { src: string; alt: string; category: Category; span?: string }[] = [
  { src: galleryCeremony, alt: "Cérémonie de remise des diplômes", category: "ceremonie", span: "col-span-2" },
  ...
  { src: galleryMakeup3, alt: "Pratique de maquillage en duo", category: "maquillage" },
  { src: galleryMakeup4, alt: "Étudiante en esthétique – résultat final", category: "maquillage" },
  { src: galleryMakeup5, alt: "Maquillage de soirée – rendu professionnel", category: "maquillage", span: "col-span-2" },
